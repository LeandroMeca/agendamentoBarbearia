...
import { ClientScheduleAppointmentModel, SaveScheduleModel, ScheduledAppintementMonthModel, SelectClientModel } from '../schedule.models';
import { SaveClientRequest } from '../../services/api-client/clients/client.models';
...
export class SchedulesMonthComponent implements OnInit, OnDestroy{
  ...
  monthSchedule!: ScheduledAppintementMonthModel;
