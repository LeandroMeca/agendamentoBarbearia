...
import { SaveClientRequest, updateClientResponse, updateClientRequest, ListClientResponse, DetailClientResponse, SaveClientResponse } from './client.models';
...
export class ClientsService implements IClientService{
  ...
  findById(id: number): Observable<DetailClientResponse> {
    return this.http.get<DetailClientResponse>(`${this.basePath}clientes/${id}`)
  }
}
